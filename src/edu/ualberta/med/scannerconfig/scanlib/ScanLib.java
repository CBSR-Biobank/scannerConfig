...
public abstract class ScanLib {
    ...
    public static final int DPI_720 = 720;

    public static final int DPI_800 = 800;
     ...
     * @param dpi The dots per inch for the image. Possible values are 200, 300,
     *            400, 600, 720, 800.
    ...
    public abstract int slDecodePlateMultipleDpi(long verbose, long dpi1,
        ...
        long squareDev, long edgeThresh, long corrections, double cellDistance);
