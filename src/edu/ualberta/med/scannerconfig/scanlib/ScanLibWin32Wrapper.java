...
public class ScanLibWin32Wrapper {
	...
	public static int slIsDriverWia() {
		return ScanLibWin32WrapperJNI.slIsDriverWia();
	}

	public static int slScanImage(long verbose, long dpi, int brightness,
			int contrast, double left, double top, double right, double bottom,
			String filename) {
		return ScanLibWin32WrapperJNI.slScanImage(verbose, dpi, brightness,
				contrast, left, top, right, bottom, filename);
	}

	public static int slDecodePlate(long verbose, long dpi, int brightness,
		...
		return ScanLibWin32WrapperJNI.slDecodePlate(verbose, dpi, brightness,
				contrast, plateNum, left, top, right, bottom, scanGap,
				squareDev, edgeThresh, corrections, cellDistance);
	}

	public static int slDecodePlateMultipleDpi(long verbose, long dpi1,
			...
			double cellDistance) {
		return ScanLibWin32WrapperJNI.slDecodePlateMultipleDpi(verbose, dpi1,
				dpi2, dpi3, brightness, contrast, plateNum, left, top, right,
				bottom, scanGap, squareDev, edgeThresh, corrections,
				cellDistance);
	}

	public static int slDecodeImage(long verbose, long plateNum,
			String filename, double scanGap, long squareDev, long edgeThresh,
			long corrections, double cellDistance) {
		return ScanLibWin32WrapperJNI.slDecodeImage(verbose, plateNum,
				filename, scanGap, squareDev, edgeThresh, corrections,
				cellDistance);
	}
